...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    MasterViewController *masterViewController = [[[segue destinationViewController] viewControllers] objectAtIndex:0];
    [masterViewController setArrUsers:_arrConnectedDevices];
}
